...
def test(config_test):
    ...
    # 测试模型
    accuracy, all_preds, all_targets, class_accuracy = my_utils.test_model(
    ...
    my_utils.plot_confusion_matrix(all_targets, all_preds, confusion_matrix_path, class_names)
